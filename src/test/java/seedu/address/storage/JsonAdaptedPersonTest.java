...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, INVALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_TAGS, VALID_MODULES, VALID_TUTORIALS, VALID_STUDENT_NUMBER, VALID_TELEGRAM);
    ...
    public void toModelType_invalidModules_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_TAGS, invalidModules, VALID_TUTORIALS, VALID_STUDENT_NUMBER, VALID_TELEGRAM);
    ...
    public void toModelType_nullStudentNumber_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_TAGS, VALID_MODULES, VALID_TUTORIALS, null, VALID_TELEGRAM);
    ...
    public void toModelType_nullTelegram_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_TAGS, VALID_MODULES, VALID_TUTORIALS, VALID_STUDENT_NUMBER, null);
