...
public class TypicalPersons {
    ...
    public static final Person DANIEL = new PersonBuilder().withName("Daniel Meier").withPhone("87652533")
            .withEmail("cornelia@example.com").withStudentNumber("A0103220J").withAddress("10th street")
            .withTelegram("@bruh")
            .withTags("friends").build();
    public static final Person ELLE = new PersonBuilder().withName("Elle Meyer").withPhone("9482224")
            .withEmail("werner@example.com").withStudentNumber("A0253220J").withTelegram("@bruh")
            .withAddress("michegan ave").build();
    public static final Person FIONA = new PersonBuilder().withName("Fiona Kunz").withPhone("9482427")
            .withEmail("lydia@example.com").withStudentNumber("A1203220J").withTelegram("@bruh")
            .withAddress("little tokyo").build();
    public static final Person GEORGE = new PersonBuilder().withName("George Best").withPhone("9482442")
            .withEmail("anna@example.com").withStudentNumber("A0203466J").withTelegram("@bruh")
    ...
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            ...
            .withAddress(VALID_ADDRESS_AMY).withTags(VALID_TAG_FRIEND).withTelegram(VALID_TELEGRAM_AMY).build();
