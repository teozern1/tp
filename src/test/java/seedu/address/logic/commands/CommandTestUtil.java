...
public class CommandTestUtil {
    ...
    public static final String INVALID_STUDENT_NUMBER_DESC = " " + PREFIX_STUDENT_NUMBER + "__**&123j"; // '_' not allowed in student number
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withTags(VALID_TAG_FRIEND).withStudentNumber(VALID_STUDENT_NUMBER_AMY).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withStudentNumber(VALID_STUDENT_NUMBER_BOB)
