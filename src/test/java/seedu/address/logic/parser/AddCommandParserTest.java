...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + TAG_DESC_FRIEND + STUDENT_NUMBER_DESC_BOB + TELEGRAM_DESC_BOB,
        ...
        assertParseSuccess(parser,
                NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND
                        + TAG_DESC_FRIEND + STUDENT_NUMBER_DESC_BOB + TELEGRAM_DESC_BOB,
    ...
    public void parse_repeatedNonTagValue_failure() {
        ...
        assertParseFailure(parser, TELEGRAM_DESC_BOB + validExpectedPersonString,
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                        + STUDENT_NUMBER_DESC_AMY + TELEGRAM_DESC_AMY,
                new AddCommand(expectedPerson));
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND + STUDENT_NUMBER_DESC_BOB + TELEGRAM_DESC_BOB,
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INVALID_TAG_DESC + VALID_TAG_FRIEND + STUDENT_NUMBER_DESC_BOB + TELEGRAM_DESC_BOB,
                Tag.MESSAGE_CONSTRAINTS);

        // invalid student number
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND + INVALID_STUDENT_NUMBER_DESC + TELEGRAM_DESC_BOB,
                StudentNumber.MESSAGE_CONSTRAINTS);

        // invalid telegram
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND + STUDENT_NUMBER_DESC_BOB + INVALID_TELEGRAM_DESC,
                Telegram.MESSAGE_CONSTRAINTS);

        // two invalid values, only first invalid value reported
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC
                        + STUDENT_NUMBER_DESC_BOB + TELEGRAM_DESC_BOB,
                Name.MESSAGE_CONSTRAINTS);
